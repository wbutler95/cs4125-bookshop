...
import StaffControls.DeleteCustomerControl;
import java.awt.*;
...
public class DeleteCustomer extends JFrame implements ActionListener {
    ...
    private JButton jbtDeleteCustomer;
    private JPanel menu;
    ...
    public DeleteCustomer(String userName) {
        ...
        jbtDeleteCustomer = new JButton("Delete Customer");
        jbtDeleteCustomer.setPreferredSize(new Dimension(100, 100));
        jbtDeleteCustomer.addActionListener(this);
        jbtDeleteCustomer.setBackground(new Color(59, 89, 182));
        jbtDeleteCustomer.setForeground(Color.WHITE);
        jbtDeleteCustomer.setToolTipText("Click to delete customer selected from list");
        jbtDeleteCustomer.setEnabled(false);
        ...
        jbtDeleteCustomer.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jbtDeleteCustomer.setBackground(Color.BLACK);
            }
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (e.getValueIsAdjusting() == false) {
                    if (list.getSelectedIndex() == -1/* && choice ==-1*/) {
                        ...
                        //Selection.
                        jbtDeleteCustomer.setEnabled(true);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source.equals(jbtDeleteCustomer)) {
            DeleteCustomerControl deleteCustomerObject = new DeleteCustomerControl();
            deleteCustomerObject.deleteCustomer(choice);
            ManageCustomerMenu mcmenu = new ManageCustomerMenu(userName);
            this.setVisible(false);
        }
    }
