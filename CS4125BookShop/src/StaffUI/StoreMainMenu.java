...
public class StoreMainMenu extends JFrame implements ActionListener
{
	...
	public StoreMainMenu ()
	{
		...
		//jbtManageBooks.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		...
		//jbtManageStock.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		...
		//jbtManageStaff.setBorder(BorderFactory.createLineBorder(Color.BLACK));
